...
import 'package:newsee/pages/formstatus_page.dart';
...
class NewLeadPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: WillPopScope(
          onWillPop: () async{
          final isUnsaved = context.read<FormStateCubit>().isFormUnsaved();
          if (isUnsaved) {
...
/* 
 if any page is dirty or value is changed not saved, if user tried to navigate.pop then show alert
 */
