      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap:
                () =>
                    _showFullScreenChart(context, chart, 'Target vs Achieved'),
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap:
                () =>
                    _showFullScreenChart(context, chart, 'Branch-wise Revenue'),
            child: SizedBox(height: chartHeight, child: chart),
          ),
        ],
      ),
    ...
    return _selectedChartType == 'Bar'
        ? BarChart(
          BarChartData(
            ...
            maxY:
                (data
                        .map((e) => e.value1 + (singleSeries ? 0 : e.value2))
                        .reduce((a, b) => a > b ? a : b) *
                    1.2),
          ),
